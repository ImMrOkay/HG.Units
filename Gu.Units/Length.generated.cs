...
namespace Gu.Units
{
    ...
    [Serializable]
    public partial struct Length : IQuantity<LengthUnit>, IComparable<Length>, IEquatable<Length>, IXmlSerializable
    {
        /// <summary>
...
#pragma warning restore SA1307 // Accessible fields must begin with upper-case letter
        ...
        {
            return obj is Length other && this.Equals(other);
        }
        ...
        public void ReadXml(XmlReader reader)
        {
            ...
            this  = new Length(XmlConvert.ToDouble(attribute), LengthUnit.Metres);
